...
const perPerson = 'pour 2 personnes';
const period = '01 nov. – 19 déc. 2026 et 11 janv. – 30 avr. 2027';
const roomNight = (amount: number) => `USD ${amount} par chambre et par nuit`;
