    ...
    const context = gsap.context(() => {
      ...
      sceneRefs.current.forEach((scene, index) => {
        ...
        timeline
          .fromTo(
            media,
            { scale: 1.04, yPercent: index % 2 === 0 ? -2.5 : 2.5, filter: 'brightness(.9) saturate(.96)' },
            { scale: 1.18, yPercent: index % 2 === 0 ? 2.5 : -2.5, filter: 'brightness(1.1) saturate(1.06)', duration: 1, ease: 'none' },
            0,
          )
          .fromTo(wash, { autoAlpha: 0.42 }, { autoAlpha: 0.12, duration: 0.45, ease: 'power2.out' }, 0)
        ...
        timeline
          ...
          .to(wash, { autoAlpha: 0.38, duration: 0.21 }, 0.79)
